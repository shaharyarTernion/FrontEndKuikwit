        ...
        <>
            <Box className={classes.root}>
                ...
                <Box className={classes.form}>
                    ...
                    <Box mt={1}>
                        <KuikTextField id="confirmPassword"
                    ...
                    <Box className={classes.terms} >
                        <FormControlLabel
                            control={<Checkbox />}
                            label={<Typography className={classes.label}>I agree to Kuikwit’s Terms & Conditions and Privacy
                                Policy</Typography>} sx={{ '& .MuiSvgIcon-root': { fontSize: 20, } }}
                        />
                    </Box>
                    <AuthButton text='Sign Up' />
                    <Box className={classes.divider}> <Divider className={classes.dividerText}>or</Divider></Box>
                    <ThirdPartyLoginButton text="Sign up with Google" icon={<GoogleSvgComponent />} />
                    <ThirdPartyLoginButton text="Sign up with Facebook" icon={<FacebookSvgComponent />} />
                    <ThirdPartyLoginButton text="Sign up with Linkedin" icon={<LinkedinSvgComponent />} />
                    <Box sx={{ display: "flex" }} mt={3}>
                        <Typography className={classes.footer}>Already have an account? &nbsp;   <Link>Sign in</Link></Typography>
                    </Box>
                </Box>
            </Box>
        </>
